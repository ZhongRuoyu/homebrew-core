...
class Glibc < Formula
  ...
  resource "bootstrap-binutils" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-binutils-2.43.1.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-binutils-2.43.1.tar.gz"
    end
  end

  resource "bootstrap-bison" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-bison-3.8.2.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-bison-3.8.2.tar.gz"
    end
  end

  resource "bootstrap-gawk" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-gawk-5.3.1.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-gawk-5.3.1.tar.gz"
    end
  end

  resource "bootstrap-gcc" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-gcc-9.5.0.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-gcc-9.5.0.tar.gz"
    end
  end

  resource "bootstrap-make" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-make-4.4.1.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-make-4.4.1.tar.gz"
    end
  end

  resource "bootstrap-python3" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-python3-3.11.10.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-python3-3.11.10.tar.gz"
    end
  end

  resource "bootstrap-sed" do
    on_intel do
      url "file:///tmp/bootstrap-binaries/bootstrap-x86_64-sed-4.9.tar.gz"
    end

    on_arm do
      url "file:///tmp/bootstrap-binaries/bootstrap-aarch64-sed-4.9.tar.gz"
    end
  end
  ...
  def install
    ...
    # Add -march and -O2 when building in CI since we are not using the compiler shim.
    if ENV["HOMEBREW_GITHUB_ACTIONS"]
      ENV.append "CFLAGS", case Hardware::CPU.arch
      when :x86_64 then "-march=core2 -O2"
      when :arm64 then "-march=armv8-a -O2"
      end
    end
